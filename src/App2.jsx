            ...
            <div className="main-container">
                <div className="info-container">
                    ...
                    <div className="navigation-container">                        
                        <a className="navigation-link_container" href="#graphic-design">
                            <div className={`navigation-item ${activeSection === "graphic-design" ? "active" : ""}`}>
                                Graphic Design
                            </div>
                        </a>
                        <a className="navigation-link_container" href="#shopify-storefronts">
                            <div className={`navigation-item ${activeSection === "shopify-storefronts" ? "active" : ""}`}>
                                Shopify Storefronts
                            </div>
                        </a>
                        <a className="navigation-link_container" href="#landing-pages">
                            <div className={`navigation-item ${activeSection === "landing-pages" ? "active" : ""}`}>
                                Landing Pages
                            </div>
                        </a>
                        <a className="navigation-link_container" href="#motion-graphics">
                            <div className={`navigation-item ${activeSection === "motion-graphics" ? "active" : ""}`}>
                                Motion Graphics
                            </div>
                        </a>
                        <a className="navigation-link_container" href="#email-marketing">
                            <div className={`navigation-item ${activeSection === "email-marketing" ? "active" : ""}`}>
                                Email Marketing
                            </div>
                        </a>
                        <a className="navigation-link_container" href="#level-design">
                            <div className={`navigation-item ${activeSection === "level-design" ? "active" : ""}`}>
                                Level Design
                            </div>
                        </a>
                        <a className="navigation-link_container" href="#games">
                            <div className={`navigation-item ${activeSection === "games" ? "active" : ""}`}>
                                Games
                            </div>
                        </a>
                    </div>
